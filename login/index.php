...
<body class="overflow-hidden">
                ...
                <form id="loginform" action="../server/login.php" method="POST" class="w-3/4 grid grid-cols-1 gap-8">
                    ...
                    <div>
                        <div class="input-field relative p-2 group text-xl cursor-pointer">
                            <input class="text-2xl bg-gray-100 p-2 outline-none w-full" type="email" name="email" id="emailforminput" autocomplete="email" placeholder=" " required>
                        ...
                        <div class="input-field relative p-2 text-xl cursor-pointer">
                            <input class="text-2xl bg-gray-100 p-2 outline-none w-full" type="password" name="password" id="passwordforminput" autocomplete="password" placeholder=" " required>
            ...
            <div class="bg-white p-10 w-full h-full flex flex-col justify-center items-center rounded-md">
                <form id="signupForm" action="../server/signup.php" method="POST" class="w-3/4 grid grid-cols-1 gap-8">
                    ...
                    <div>
                        ...
                        <div class="input-field relative p-2 group text-xl cursor-pointer">
                            <input class="text-2xl bg-gray-100 p-2 outline-none w-full" type="text" name="city" id="cityforminput" autocomplete="bday" placeholder=" " required>
                            <label class="absolute text-gray-600 pl-4 top-1/4 left-0 text-2xl select-none" for="cityforminput">By</label>
                        </div>
                        <div class="input-field relative p-2 group text-xl cursor-pointer">
                            <input class="text-2xl bg-gray-100 p-2 outline-none w-full" type="text" name="firstname" id="firstnameforminput" autocomplete="bday" placeholder=" " required>
                            <label class="absolute text-gray-600 pl-4 top-1/4 left-0 text-2xl select-none" for="firstnameforminput">Fornavn</label>
                        </div>
                        <div class="input-field relative p-2 group text-xl cursor-pointer">
                            <input class="text-2xl bg-gray-100 p-2 outline-none w-full" type="text" name="surname" id="surnameforminput" autocomplete="bday" placeholder=" " required>
                    ...
                    <div>
                        <div class="input-field relative p-2 group text-xl cursor-pointer">
                            <input class="text-2xl bg-gray-100 p-2 outline-none w-full" type="email" name="newemail" id="newemailforminput" autocomplete="email" placeholder=" " required>
                            <label class="absolute text-gray-600 pl-4 top-1/4 left-0 text-2xl select-none" for="newemailforminput">Email</label>
                        </div>

                        <div class="input-field relative p-2 text-xl cursor-pointer">
                            <input class="text-2xl bg-gray-100 p-2 outline-none w-full" type="password" name="newpassword" id="newpasswordforminput" autocomplete="new-password" placeholder=" " required>
    ...
    <script type="text/javascript" src="./modalSlider.js"></script>
</body>
